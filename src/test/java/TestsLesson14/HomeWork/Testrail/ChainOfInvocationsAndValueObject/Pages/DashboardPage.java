...
import TestsLesson14.HomeWork.Testrail.ChainOfInvocationsAndValueObject.Core.ReadProperties;
...
public class DashboardPage extends BasePage {
    ...
    protected void openPage() {
        driver.get("https://alenaqazxsw.testrail.io/index.php?/dashboard");
    }
